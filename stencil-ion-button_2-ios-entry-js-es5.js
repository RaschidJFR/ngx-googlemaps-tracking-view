(function () {
  ...
  (self["webpackChunktracking_view"] = self["webpackChunktracking_view"] || []).push([["stencil-ion-button_2-ios-entry-js"], {
    /***/
    93112: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        ...
        function Button(hostRef) {
          ...
          this.handleClick = function (ev) {
            if (_this.type === 'button') {
              (0, _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__.o)(_this.href, ev, _this.routerDirection);
            } else if ((0, _helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__.h)(_this.el)) {
        ...
        _createClass(Button, [{
          ...
          value: function render() {
            ...
            return (0, _index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__.H, {
              ...
              "class": Object.assign(Object.assign({}, (0, _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__.c)(color)), (_Object$assign = {}, _defineProperty(_Object$assign, mode, true), _defineProperty(_Object$assign, buttonType, true), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(expand), expand !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(finalSize), finalSize !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(shape), shape !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(fill), true), _defineProperty(_Object$assign, "".concat(buttonType, "-strong"), strong), _defineProperty(_Object$assign, 'in-toolbar', (0, _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-toolbar', this.el)), _defineProperty(_Object$assign, 'in-toolbar-color', (0, _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-toolbar[color]', this.el)), _defineProperty(_Object$assign, 'button-has-icon-only', hasIconOnly), _defineProperty(_Object$assign, 'button-disabled', disabled), _defineProperty(_Object$assign, 'ion-activatable', true), _defineProperty(_Object$assign, 'ion-focusable', true), _Object$assign))
      ...
      var Icon = /*#__PURE__*/function () {
        ...
        _createClass(Icon, [{
          ...
          value: function loadIcon() {
            ...
            if (this.isVisible) {
              var url = (0, _utils_35117408_js__WEBPACK_IMPORTED_MODULE_2__.g)(this);
            ...
            if (!this.ariaLabel) {
              var label = (0, _utils_35117408_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.name, this.icon, this.mode, this.ios, this.md); // user did not provide a label
          ...
          value: function render() {
            ...
            }, this.svgContent ? (0, _index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "icon-inner",
