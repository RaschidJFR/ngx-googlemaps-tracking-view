  ...
  function node_modulesIonicCoreDistEsmIonAlertIosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const Alert = class {
      ...
      renderCheckbox(labelledby) {
        ...
        }, inputs.map(i => Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
      ...
      renderAlertButtons() {
        ...
        }, buttons.map(button => Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
