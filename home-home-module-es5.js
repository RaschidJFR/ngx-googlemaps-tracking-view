(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function node_modulesAngularCommonFesm2015HttpJs(module, __webpack_exports__, __webpack_require__) {
          ...
          */
          update => {
            switch (update.op) {
              ...
              case 's':
                /** @type {?} */
                const base = (update.op === 'a' ?
                /** @type {?} */
                this.map.get(update.param) : undefined) || [];
                base.push(
                /** @type {?} */
                update.value);
    ...
    class HttpRequest {
      ...
      clone(update = {}) {
        ...
        if (update.setHeaders !== undefined) {
          ...
          * @return {?}
          */
          (headers, name) => headers.set(name,
          /** @type {?} */
          update.setHeaders[name]), headers);
        ...
        if (update.setParams) {
          ...
          * @return {?}
          */
          (params, param) => params.set(param,
          /** @type {?} */
          update.setParams[param]), params);
    ...
    class HttpClient {
      ...
      request(first, url, options = {}) {
        ...
        * @return {?}
        */
        req => this.handler.handle(req))); // If coming via the API signature which accepts a previously constructed HttpRequest,
        ...
        * @return {?}
        */
        event => event instanceof HttpResponse)); // Decide which stream to return.
      ...
      handle(req) {
        ...
        */
        observer => {
          ...
          const url = req.urlWithParams.replace(/=JSONP_CALLBACK(&|$)/, "=".concat(callback, "$1")); // Construct the <script> tag and point it at the URL.
      ...
      handle(req) {
        ...
        */
        observer => {
          ...
          * @return {?}
          */
          (name, values) => xhr.setRequestHeader(name, values.join(','))); // Add an Accept header if one isn't present already.
  ...
  /***/
  function node_modulesDiacriticsIndexJs(module, exports) {
  ...
  /***/
  function node_modulesExtractSvgPathBrowserJs(module, exports, __webpack_require__) {
  ...
  /***/
  function node_modulesGeolocationMarkerGeolocationMarkerJs(module, exports) {
    (function () {
      /*
  ...
  /***/
  function node_modulesGlobalWindowJs(module, exports) {
    var win;
  ...
  /***/
  function node_modulesI18nIsoCountriesCodesJson(module) {
  ...
  /***/
  function node_modulesI18nIsoCountriesIndexJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    /*! diacritics */
    "./node_modules/diacritics/index.js").remove;
  ...
  /***/
  function node_modulesI18nIsoCountriesLangsEnJson(module) {
  ...
  /***/
  function node_modulesLoadSvgIndexJs(module, exports, __webpack_require__) {
  ...
  /***/
  "./node_modules/ngx-googlemaps-tracking-view/fesm2015/ngx-googlemaps-tracking-view.js":
  /*!********************************************************************************************!*\
    !*** ./node_modules/ngx-googlemaps-tracking-view/fesm2015/ngx-googlemaps-tracking-view.js ***!
    \********************************************************************************************/
  ...
  /***/
  function node_modulesNgxGooglemapsTrackingViewFesm2015NgxGooglemapsTrackingViewJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgxGooglemapsTrackingViewComponent", function () {
      return NgxGooglemapsTrackingViewComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxGooglemapsTrackingViewModule", function () {
    ...
    var geolocation_marker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! geolocation-marker */
    "./node_modules/geolocation-marker/geolocation-marker.js");
    /* harmony import */


    var geolocation_marker__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(geolocation_marker__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */
    ...
    class GoogleMapsWrapper {
      constructor() {
        ...
        this.onReady = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
        /**
        ...
        this.boundsChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
      ...
      getInfowindow(id = 'default') {
        ...
        if (!infowindow) {
          ...
          infowindow['closeclick'] = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
    ...
    class CenterMarker {
       ...
       * @param {?} http
       */
      constructor(googlemapsWrapper, viewContainer, cdr, http) {
        ...
        this.addressChanges = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
        /**
         * Emitted when the pin's location has changed (by zooming or dragging) and the map has become idle again.
         */

        this.locationChanges = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
        /**
         * @ignore
         */

        this._centerChanged$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        /**
         * @ignore
         */

        this._mapEventSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subscription"]();
        /**
         * @ignore
         */
      ...
      get REVERSE_GEOCODING_URL() {
        return "https://maps.googleapis.com/maps/api/geocode/json?key=".concat(API_KEY, "&latlng=");
      }
      /**
      ...
      enable(infowindowTemplate, apiKey) {
        ...
        const mapDiv =
        /** @type {?} */
        this.googlemapsWrapper.map.getDiv();
        ...
        */
        ...
        this._mapEventSubscription.add(this._centerChanged$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["tap"])(
        /**
        * @return {?}
        */
        () => {
        ...
        * @return {?}
        */
        latLng => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(latLng)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["debounce"])(
        /**
        * @return {?}
        */
        () => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(1000)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["switchMap"])(
        /**
        * @param {?} latLng
        * @return {?}
        */
        latLng =>
        /** @type {?} */
        this.http.get("".concat(this.REVERSE_GEOCODING_URL).concat(latLng.toUrlValue())))) // .subscribe((latLng) => {
        .subscribe(
        /**
        * @param {?} response
        * @return {?}
      ...
      displayInfowindowOverPin() {
        ...
        const view = this.viewContainer.createEmbeddedView(this._infowindowTemplate, {
    ...
    class NgxGooglemapsTrackingViewComponent {
       ...
       * @param {?} cdr
       */
      constructor(googlemapsWrapper, vc, http, cdr) {
        this.googlemapsWrapper = googlemapsWrapper;
        this.vc = vc;
        this.http = http;
        this.cdr = cdr;
        ...
        this.centerPin = new CenterMarker(this.googlemapsWrapper, this.vc, this.cdr, this.http);
        this._data = [];
        /**
    ...
    NgxGooglemapsTrackingViewComponent.decorators = [{
      ...
      args: [{
        ...
        styles: ["#map{width:100%;height:100%;z-index:0}#map ::ng-deep .gm-style>div:first-child>div:first-child{z-index:-1!important}"]
      }]
    }];
    /** @nocollapse */
    ...
    class InfowindowComponent {
      ...
      constructor(googleMaps, el) {
        ...
        this.closeclick = new _angular_core__WEBPACK_IMPORTED_MODULE_4__["EventEmitter"]();
    ...
    class TrackedObjectComponent {
      ...
      ngAfterContentInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_1__["__awaiter"])(this, void 0, void 0, function* () {
          yield this.googleMaps.ready(); // Add bounds changed event
      ...
      checkRenderObject() {
        /** @type {?} */
        const path = this.polygon && this.polygon.getPath(); // If showing a polygon
      ...
      getSpeedLineIcons() {
        ...
        const skipIconOnFifth = false; // Units
      ...
      drawObject() {
        ...
        const showSpeedLine = this.drawSpeedVector && this.isMoving && this.zoom >= LOD.speed; // Show triangle
    ...
    class GeolocationButtonComponent {
      ...
      centerOnUser() {
        ...
        if (navigator.geolocation) {
          ...
          * @return {?}
          */
          position => this.onPosition(position), console.error, {
      ...
      onPosition(position) {
        ...
        const lat = position.coords.latitude; // this.googlemapsWrapper.map.setCenter({ lat, lng });
        // if (this._geoLocationMarker) this._geoLocationMarker.setMap(null);
        // this._geoLocationMarker = new GeolocationMarker(this.googlemapsWrapper.map);
        // this.locate.emit(this._geoLocationMarker.position);
    ...
    NgxGooglemapsTrackingViewModule.decorators = [{
      ...
      args: [{
        declarations: [NgxGooglemapsTrackingViewComponent, TrackedObjectComponent, InfowindowComponent, GeolocationButtonComponent],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"]],
        providers: [GoogleMapsWrapper],
        exports: [NgxGooglemapsTrackingViewComponent, InfowindowComponent, GeolocationButtonComponent]
      }]
    }];
    /**
     * @fileoverview added by tsickle
  ...
  /***/
  function node_modulesParseHeadersParseHeadersJs(module, exports) {
  ...
  /***/
  function node_modulesParseSvgPathIndexJs(module, exports) {
  ...
  /***/
  function node_modulesRandomcolorRandomColorJs(module, exports, __webpack_require__) {
  ...
  /***/
  function node_modulesXhrIndexJs(module, exports, __webpack_require__) {
  ...
  /***/
  function node_modulesXhrNode_modulesOnceOnceJs(module, exports) {
    module.exports = once;
  ...
  /***/
  function node_modulesXmlParseFromStringIndexJs(module, exports) {
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_googlemaps_tracking_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    HomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      providers: [],
      imports: [ngx_googlemaps_tracking_view__WEBPACK_IMPORTED_MODULE_6__["NgxGooglemapsTrackingViewModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild([{
        path: '',
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var i18n_iso_countries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! i18n-iso-countries */
    "./node_modules/i18n-iso-countries/index.js");
    /* harmony import */


    var i18n_iso_countries__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(i18n_iso_countries__WEBPACK_IMPORTED_MODULE_4__);
    /* harmony import */


    var randomcolor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! randomcolor */
    "./node_modules/randomcolor/randomColor.js");
    /* harmony import */


    var randomcolor__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(randomcolor__WEBPACK_IMPORTED_MODULE_5__);
    /* harmony import */


    var parse_svg_path__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! parse-svg-path */
    "./node_modules/parse-svg-path/index.js");
    /* harmony import */


    var parse_svg_path__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(parse_svg_path__WEBPACK_IMPORTED_MODULE_6__);
    /* harmony import */


    var extract_svg_path__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! extract-svg-path */
    "./node_modules/extract-svg-path/browser.js");
    /* harmony import */


    var extract_svg_path__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(extract_svg_path__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */


    var load_svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! load-svg */
    "./node_modules/load-svg/index.js");
    /* harmony import */


    var load_svg__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(load_svg__WEBPACK_IMPORTED_MODULE_8__);
    /* harmony import */


    var _ionic_angular__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! @ionic/angular */
    "./node_modules/@ionic/angular/fesm2015/ionic-angular.js"); /// <reference types="@types/googlemaps" />


    i18n_iso_countries__WEBPACK_IMPORTED_MODULE_4__["registerLocale"](__webpack_require__(
    ...
    let HomePage = class HomePage {
      constructor(http, vc, platform) {
        ...
        load_svg__WEBPACK_IMPORTED_MODULE_8__('assets/baseline-local_airport-24px.svg', (err, svg) => {
          const paths = parse_svg_path__WEBPACK_IMPORTED_MODULE_6__(extract_svg_path__WEBPACK_IMPORTED_MODULE_7__["parse"](svg));
          const i = paths.findIndex(p => p[0] === 'z');
          this.symbolPath = paths.slice(0, i - 1).map(p => p.join(' ')).join(' ');
        });
      }
      ...
      getAircracts() {
        ...
        this.http.get("https://opensky-network.org/api/states/all?lamin=".concat(sw.lat(), "&lomin=").concat(sw.lng(), "&lamax=").concat(ne.lat(), "&lomax=").concat(ne.lng())).subscribe(response => {
          this.objectsToTrack = response.states && response.states.map(aircraft => {
            ...
            return trkObj;
          }).filter(a => !a.onGround).splice(0, 50) || [];
        });
      }
      ...
      getIcon(rotation) {
        const color = randomcolor__WEBPACK_IMPORTED_MODULE_5__();
        return {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(ngx_googlemaps_tracking_view__WEBPACK_IMPORTED_MODULE_2__["NgxGooglemapsTrackingViewComponent"], {
      static: true
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", ngx_googlemaps_tracking_view__WEBPACK_IMPORTED_MODULE_2__["NgxGooglemapsTrackingViewComponent"])], HomePage.prototype, "mapView", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('infowindowLocation', {
      static: false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"])], HomePage.prototype, "infowindowLocation", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _ionic_angular__WEBPACK_IMPORTED_MODULE_9__["Platform"]])], HomePage);
    /***/
  }
}]);
